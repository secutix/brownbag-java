...
public class BrownBagJava8Test {
    ...
    public void step3() {
        ...
        assertThat(senders).isEqualTo(Arrays.asList(
                "@secutix",
                "@Clusis_Suisse",
                "@lehub_agence",
                "@amilcarvargas",
    ...
    public void step6() {
        ...
        assertThat(lambdaTweets.stream().map(Tweet::getId).collect(Collectors.toList()))
            .isEqualTo(Arrays.asList(1L, 3L, 4L, 6L));
    }
    ...
    public void step7() {
        ...
        assertThat(lambdaTweets.stream().map(Tweet::getId).collect(Collectors.toList()))
            .isEqualTo(Arrays.asList(4L, 3L, 6L, 1L));
    }
    ...
    public void step8() {
        ...
        assertThat(hashTags).isEqualTo(
                new HashSet<>(Arrays.asList("#lehub", "#smartphone", "#audienciaub", "#hospitality", 
                                             "#secutix", "#clusis", "#teatrelliure", "#cloud", "#uefa", "#ticketing")));
    }
    ...
    public void step9() {
        ...
        assertThat(Arrays.asList(2L)).isEqualTo(
                tweetsBySender.get("@Clusis_Suisse").stream().map(Tweet::getId).collect(Collectors.toList()));
        assertThat(Arrays.asList(4L)).isEqualTo(
                tweetsBySender.get("@amilcarvargas").stream().map(Tweet::getId).collect(Collectors.toList()));
        assertThat(Arrays.asList(3L)).isEqualTo(
                tweetsBySender.get("@lehub_agence").stream().map(Tweet::getId).collect(Collectors.toList()));
        assertThat(Arrays.asList(1L, 5L, 6L)).isEqualTo(
                tweetsBySender.get("@secutix").stream().map(Tweet::getId).collect(Collectors.toList()));
    }
    ...
    public void step10() {
        ...
        assertThat(Arrays.asList(1L, 3L, 4L, 6L))
                .isEqualTo(withLambda.stream().map(Tweet::getId).collect(Collectors.toList()));
        assertThat(Arrays.asList(2L, 5L))
                .isEqualTo(withoutLambda.stream().map(Tweet::getId).collect(Collectors.toList()));
    }
