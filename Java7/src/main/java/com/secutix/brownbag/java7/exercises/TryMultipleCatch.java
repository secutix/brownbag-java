...
public class TryMultipleCatch {
	...
	/**
	 * Modify the try/catch to have only one catch block. DO NOT USE catch (Exception)
	 */
	 ...
	 */
	public static class MyClassOk implements MyInterface {
		@Override
	 ...
	 */
	public static class MyClassInstantiationException implements MyInterface {
	 ...
	 * Checked exception
	 */
	public static class MyClassThrowingException implements MyInterface {
