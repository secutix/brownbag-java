...
import bbl.exercises.TryMultipleCatch.MyException;
import bbl.exercises.TryMultipleCatch.MyInterface;
...
public class TryCatchSmart {
	...
	public static class MyTestClass {
		...
		/**
		 * DO NOT MODIFY THIS METHOD Creates an instance and verifies that the method testMethod exists
		 * 
		 * @param clazz
		 *            a class
